...
local L = LANG.CreateLanguage("hitlang")
...
L.round_selected   = "The Hitmen have been selected."
L.round_started    = "The round has begun!"
L.round_restart    = "The round has been forced to restart by an admin."

L.round_traitors_one  = "Hitman, you stand alone."
L.round_traitors_more = "Hitman, these are your allies: {names}"

L.win_time         = "Time has run out. The Hitmen lose."
L.win_traitor      = "The Hitmen have won!"
L.win_innocent     = "The Hitmen have been defeated!"
...
L.credit_tr_all    = "Hitmen, you have been awarded {num} equipment credit(s) for your performance."
...
L.quick_traitor = "{player} is a Hitman!"
...
L.c4_disarm_t     = "Cut a wire to disarm the bomb. As you are Hitman, every wire is safe. Innocents don't have it so easy!"
...
L.target_traitor = "FELLOW HITMAN"
...
L.info_popup_traitor_alone = [[You are a HITMAN! You have no fellow hitmen this round.

Kill all others to win!

Press {menukey} to receive your special equipment!]]

L.info_popup_traitor = [[You are a HITMAN! Work with fellow hitmen to kill all others.
...
L.tip1 = "Hitmen can search a corpse silently, without confirming the death, by holding {walkkey} and pressing {usekey} on the corpse."
...
L.tip7 = "When the Hitmen have made significant progress in killing innocents, they will receive an equipment credit as reward."

L.tip8 = "Hitmen and Detectives can collect unspent equipment credits from the dead bodies of other Hitmen and Detectives."
...
L.tip10 = "As Hitman or Detective, keep an eye on red messages in the top right. These will be important for you."

L.tip11 = "As Hitman or Detective, keep in mind you are rewarded extra equipment credits if you and your comrades perform well. Make sure you remember to spend them!"
...
L.tip15 = "Are you Hitman and going sniping? Consider trying out the Disguiser. If you miss a shot, run away to a safe spot, disable the Disguiser, and no one will know it was you who was shooting at them."

L.tip16 = "As Hitman, the Teleporter can help you escape when chased, and allows you to quickly travel across a big map. Make sure you always have a safe position marked."
...
L.tip18 = "Using the Radio as Hitman, you can play sounds through your Equipment Menu after the radio has been placed. Queue up multiple sounds by clicking multiple buttons in the order you want them."
...
L.tip20 = "The Detectives' Binoculars allow long-range searching and identifying of corpses. Bad news if the Hitmen were hoping to use a corpse as bait. Of course, while using the Binoculars a Detective is unarmed and distracted..."

L.tip21 =  "The Detectives' Health Station lets wounded players recover. Of course, those wounded people could be Hitmen..."
...
L.tip23 = "Unlike weapons and C4, the Radio equipment for Hitmen does not contain a DNA sample of the person who planted it. Don't worry about Detectives finding it and blowing your cover."
...
L.tip40 = "If it says 'HASTE MODE' above the round timer, the round will at first be only a few minutes long, but with every death the available time increases (like capturing a point in TF2). This mode puts the pressure on the Hitmen to keep things moving."
...
L.aw_fst2_text  = "scored the first kill by shooting a fellow Hitman. Good job."
...
L.aw_fst4_text  = "struck the first blow for the innocent terrorists by making the first death a Hitman's."
...
L.aw_all2_text  = "was responsible for every kill made by a Hitman this round."
...
L.aw_knf2_text  = "was not a Hitman, but still killed someone with a knife."
...
L.set_avoid_det_tip = "Enable this to ask the server not to select you as Detective if possible. Does not mean you are Hitman more often."
